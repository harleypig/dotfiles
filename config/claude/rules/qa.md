...
**arch-review** (4 — code-smell/complexity/maintainability), **test-review**
(6 — test-suite *quality*, vs executing), **a11y-review** (7 — UI/UX &
accessibility), **perf-review** (10 — performance). Python implementation
depth: **pytest-patterns**, **typing-patterns**. **Stack sub-pipelines** run a
whole language/tool's QA slice rather than one dimension: **terraform-review**
(the Terraform slice — format/lint/validate/native tests/docs-currency + a
