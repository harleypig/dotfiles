...
1. [Activate Developer Mode](https://docs.microsoft.com/en-us/windows/apps/get-started/enable-your-device-for-development)
...
1. Download and install [MSYS2](https://www.msys2.org/#installation), then:
   ...
   1. Set Windows `%USERPROFILE%` folder (`C:\Users\<user name>`) as the
      `$HOME` folder by adding the following contents to `C:\msys64\etc\fstab`.
      Ref: [How to change HOME directory and start directory on MSYS2?](https://stackoverflow.com/a/66946901).
...
Rip off what I can use from [LucHermitte's cyg-wrapper.sh](https://github.com/LucHermitte/Bash-scripts/blob/master/cyg-wrapper.sh)
